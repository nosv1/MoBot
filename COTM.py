...
async def memberRemove(member, client):
  ...
  await channel.send(f"{member.mention} (a.k.a. {member.display_name}) has lost his footing and has ragdolled his way down the mountain 🗻. {mo_member.mention}")
# end memberRemove
